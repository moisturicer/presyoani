      ...
      <Card className="border-0 bg-primary">
        <CardContent className="flex items-center gap-4 p-4">
          ...
          <div className="flex flex-col items-center">
            ...
            <span className="mt-0.5 text-xs font-bold text-secondary">
              480 pts
            </span>
          </div>
        </CardContent>
      ...
      <Card className="overflow-hidden border border-border">
        ...
        <CardContent className="p-0">
          <div className="relative h-52 bg-primary/5 overflow-hidden">
            ...
            {/* Map Legend */}
            <div className="absolute bottom-2 left-2 flex gap-2 rounded-lg bg-card/90 p-2 backdrop-blur-sm">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2">
                      ...
                      {harvest.verified && (
                        <Badge
                          variant="outline"
                          className="border-green-300 text-green-700 text-xs px-1.5 py-0"
                        >
                          Verified
                        </Badge>
                      )}
