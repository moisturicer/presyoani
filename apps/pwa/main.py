                ...
                try:
                    ...
                    if action == "LIST":
                        ...
                        if active:
                            ...
                            # This harvest was already sold, can't re-list it
                            await send_fb_message(sender_id, {
                                "attachment": {
                                    "type": "template",
                                    "payload": {
                                        "template_type": "button",
                                        "text": f"⚠️ Nabaligya na kining {crop_display}. I-scan ang bag-ong ani para makahimo og bag-ong listing.",
                                        "buttons": [
                                            {"type": "web_url", "url": "https://presyoani.onrender.com", "title": "➕ DAGDAG OG ANI"}
                                        ]
                                    }
                            ...
                            # No existing record, allow listing
